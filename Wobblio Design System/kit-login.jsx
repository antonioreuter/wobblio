    ...
    <div className="auth-screen">
      <div className="auth-card glass">
        ...
        <form onSubmit={submit} className="auth-form" noValidate>
          ...
          icon={<LI.mail />} defaultValue="antonio@wobblio.app" required />
          <LgInput label="Password" type="password" name="password" autoComplete="current-password"
          icon={<LI.lock2 />} defaultValue="household2026" required />
        ...
        <button type="button" className="sso-btn" onClick={submit}>
          <LI.fingerprint /> Continue with single sign-on
        </button>

        <p className="auth-foot">
          Don&apos;t have an account? <a href="#" className="auth-link strong" onClick={(e) => e.preventDefault()}>Create one</a>
        </p>
      </div>
