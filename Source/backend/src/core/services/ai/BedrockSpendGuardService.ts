import type { IBedrockConverse, BedrockConverseRequest, BedrockConverseResult } from '../../ports/ai/IBedrockConverse';
import type { IAiSpendLedger } from '../../ports/ai/IAiSpendLedger';
import type { IAiSpendCapProvider } from '../../ports/ai/IAiSpendCapProvider';
