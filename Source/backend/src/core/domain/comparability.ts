...
// 09/05 — THE COMPARABILITY RULE. Two linked offers (an item's own product and a linked sibling,
// fix 10) may be ranked together ("best price", optimizer matrix) only when they are comparable
...
export interface Offer {
  size: OfferSize;
  // The user confirmed this sibling is the same size/pack as the item (product_link size_equivalent).
